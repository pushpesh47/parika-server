...
def _tts_model_installed(config: LocalSpeechProviderConfig) -> bool:
    ...
    actually configured and present on disk -- text-to-speech becomes
    available as soon as either language has a real voice file,
    exactly like STT/TTS being independently available from each
    other (see this module's own docstring).
    """
